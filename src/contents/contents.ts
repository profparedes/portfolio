...
const Contents: ContentsType = {
  ...
  aboutMe: {
    'pt-BR': [
      ...
      'Durante esse tempo, participei de diversos projetos institucionais, até me tornar coordenador do FabLab (um laboratório de prototipagem) ali eu comecei a aplicar a programação na robótica e me aproximar cada vez mais da programação.',
    ...
    en: [
      ...
      'During this time, I participated in several institutional projects until I became the coordinator of FabLab (a prototyping laboratory), where I started applying programming to robotics and getting closer to programming more and more.',
